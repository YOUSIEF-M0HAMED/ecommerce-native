        ...
        ?>
             ...
             if ($result) {
              while ($row = $result->fetch_assoc()) {
                ...
                // $order_id=$row['id'];
                // $selectQuery2 = "SELECT * FROM users WHERE id ='$order_id' ";
                // $result2 = $conn->query($selectQuery2);
                // $customer=$result2->fetch_assoc();
                //display customer name in the table 
            ?>
                            <tbody id="user-table-body">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="edit.php?order_id=<?php echo $row['order_id'] ?>&product_id=<?php echo $row['product_id'] ?>"
                                            class="btn btn-primary btn-sm edit-btn">Edit</a>

                                        <a href="delete.php?order_id=<?php echo $row['order_id'] ?>&product_id=<?php echo $row['product_id'] ?>"
