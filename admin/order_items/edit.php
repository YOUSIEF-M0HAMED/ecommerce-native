...
<head>
    ...
    <title>Edit Order Item info</title>
        ...
        if (isset($_SESSION['success'])) { 
                ...
                ?>
                    ...
                    ?>
                        ...
                        header("location: edit.php?order_id=$order_id&product_id=$product_id");
                        exit();
                    }
                    ...
                    ?>
                            ...
                            <input type="hidden" name="old_product_id" value=" <?php echo $product_id ?> ">
...
<?php 
        ...
        echo "order id or product id is not found";
    }
}else{
